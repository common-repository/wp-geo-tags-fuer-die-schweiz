<?php
/*
   Plugin Name: WP Geo Tags fuer die Schweiz
   Plugin URI: http://www.blumenversand.ag/
   Description: WP Geo Tags fuer die Schweiz.
   Version: 0.1
   Author: Frank Kugler
...
$meta_boxes = array(
    "region" => array(
        "name" => "region",
        "title" => "geo.region",
        "description" => "Example: <em>CH-BE</em>"),
    "placename" => array(
        "name" => "placename",
        "title" => "geo.placename",
        "description" => "Example: <em>Berne</em>"),
    "position" => array(
        "name" => "position",
        "title" => "geo.position",
        "description" => "Example: <em>46.947922;7.444609</em>"),
    "ICBM" => array(
        "name" => "ICBM",
        "title" => "ICBM",
        "description" => "Example: <em>46.947922, 7.444609</em>")
